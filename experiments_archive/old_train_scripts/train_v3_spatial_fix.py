# train_v3_spatial_fix.py
"""
Training script for PIPNet-Alpha V3 Spatial Fix
Global branch preserves 4x4 spatial grid (160 tokens) instead of pooling to 1x1.
"""
...
from models.pipnet_alpha_v3_spatial_fix import PIPNetAlphaV3SpatialFix
...
def main():
    ...
    parser.add_argument("--save_dir", type=str, default="checkpoints_v3_spatial_fix")
    ...
    # Model
    print("\nBuilding model...")
    model = PIPNetAlphaV3SpatialFix(dropout_p=args.dropout_p).to(device)    
